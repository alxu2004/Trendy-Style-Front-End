      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route
            ...
            element={<AdminAddProductAcount />}
          />
          <Route
            path='/admin/add-category'
            element={<AdminAddCategoryAcount />}
          />
          <Route
            path='/admin/drop-branch'
            element={<AdminDropBranchAcount />}
          />
          <Route
            path='/admin/drop-category'
            element={<AdminDropCategoryAcount />}
          />
          <Route
            path='/admin/drop-product'
            element={<AdminDropProductAcount />}
          />
        </Routes>
      </BrowserRouter>
    </>
