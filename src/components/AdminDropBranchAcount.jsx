...
export const AdminDropBranchAcount = () => {
  ...
  const deletedBranch = async (id) => {
    try {
      ...
      const response = await fetch(
        `http://localhost:8080/api/marcas/eliminar/${id}`,
        {
          method: 'DELETE',
        },
      )
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:8080/api/marcas/actualizar/${selectedBranchId}`,
        {
          method: 'PUT',
          body: formDataToSend,
        },
              ...
              {branches.map((row) => (
                ...
                >
                  ...
                  <TableCell align='right'>
                    <img
                      width={40}
                      src={`data: image/jpeg;base64,${row.img} `}
                    />
                  </TableCell>
